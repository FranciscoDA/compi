...
jge LABEL_8
	fild VAR_ACTUAL
fld CTE_FLT_1 ; value=99999.99cmp
jgl LABEL_3
...
jmp LABEL_9
LABEL_8:
fld CTE_FLT_2 ; value=333.3333	fild VAR_ACTUAL
LABEL_9:
	fild VAR_ACTUAL
	fild VAR_ACTUAL
fadd
