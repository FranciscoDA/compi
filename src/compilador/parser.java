...
/** CUP v0.11a beta 20060608 generated parser.
  * @version Thu Nov 09 07:07:34 ART 2017
  */
  ...
  public SymbolTableEntry.TypeName getExpressionType(LinkedList<rpn.Node> l) {
  	for (rpn.Node i : l) {
  		if (i instanceof rpn.VariableExpression) {
  			...
  			if (getVariableType(vex.getName()) == SymbolTableEntry.TypeName.FLOAT) {
  				return SymbolTableEntry.TypeName.FLOAT;
  			}
  		}
  	...
  	return SymbolTableEntry.TypeName.INTEGER;
  }
